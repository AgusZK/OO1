...
public class Mamifero {
    ...
    // NO HAGO ABUELOS PORQUE SERIAN LOS PADRES DE MIS PADRES
    ...
    public boolean tieneComoAncestroA(Mamifero unMamifero) {
        ...
        if (this.padre != null && this.padre.tieneComoAncestroA((unMamifero))){ return true; }

        if (this.madre != null && this.madre.tieneComoAncestroA(unMamifero)){ return true; }
